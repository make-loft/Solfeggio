...
public class AudioInputEventArgs(ProcessingProfile source, Complex[] sample, double sampleRate) : EventArgs
{
	public ProcessingProfile Source { get; } = source;
	public Complex[] Sample { get; } = sample;
