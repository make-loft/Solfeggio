...
public partial class Wave
{
	public static partial class Out
	{
		...
		[DllImport("winmm.dll")] public static extern MmResult waveOutPrepareHeader(IntPtr hWaveOut, Header lpWaveOutHdr, int uSize);
		[DllImport("winmm.dll")] public static extern MmResult waveOutUnprepareHeader(IntPtr hWaveOut, Header lpWaveOutHdr, int uSize);
		[DllImport("winmm.dll")] public static extern MmResult waveOutWrite(IntPtr hWaveOut, Header lpWaveOutHdr, int uSize);
